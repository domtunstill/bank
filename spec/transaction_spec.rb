...
describe Transaction do
    ...
    it 'returns the deposited ammount' do
        transaction = Transaction.new(deposit: 100, date: Date.new(2012, 01, 10), current_balance: 900)
        expect(transaction.deposit).to eq (100)
    end

    it 'returns the withdrawn ammount' do
        transaction = Transaction.new(withdrawal: 100, date: Date.new(2012, 01, 10), current_balance: 900)
